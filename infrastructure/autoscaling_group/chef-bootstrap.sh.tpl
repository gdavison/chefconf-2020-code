...
aws ssm get-parameter --name "chef-infra-server-validator" --region ca-central-1 --with-decryption \
    ...
    | sed 's/\\n/\n/g' \
    > /etc/chef/example_org-validator.pem
...
/bin/echo -e "chef_server_url  \"https://${chef_infra_server_url}/organizations/example_org\"" >> /etc/chef/client.rb
/bin/echo -e "validation_client_name \"example_org-validator\"" >> /etc/chef/client.rb
/bin/echo -e "validation_key \"/etc/chef/example_org-validator.pem\"" >> /etc/chef/client.rb
